...
class ImageProfile extends Image
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MireiaBackend\BackendBundle\Entity\AdminUser", inversedBy="imagesProfile", cascade={"persist", "remove", "merge"})
     */
    protected $user;
    ...
    public function setUser(\MireiaBackend\BackendBundle\Entity\AdminUser $user)
    {
        $this->user = $user;
    }
