 ...
 * @ORM\DiscriminatorMap({"imagethumbnail"="ImageThumbnail", "imageprofileavatar"="ImageProfileAvatar",
 * "imageprofilesquare"="ImageProfileSquare"})
 */
abstract class ImageCopy
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MireiaBackend\ImageBundle\Entity\Image", inversedBy="imageCopies")
     */
    protected $image;
