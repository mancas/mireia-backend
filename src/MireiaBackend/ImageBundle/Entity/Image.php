...
namespace MireiaBackend\ImageBundle\Entity;

use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;
use Gedmo\Mapping\Annotation as Gedmo;
use MireiaBackend\ImageBundle\Util\FileHelper;
 ...
 * @ORM\DiscriminatorMap({"avatar"="ImageAvatar", "profile"="ImageProfile"})
 */
abstract class Image
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="MireiaBackend\ImageBundle\Entity\ImageCopy", mappedBy="image", cascade={"persist", "merge", "remove"})
     */
    ...
    public function setImageThumbnail(\MireiaBackend\ImageBundle\Entity\ImageThumbnail $thumbnail)
    {
    ...
    public function setImageProfileAvatar(\MireiaBackend\ImageBundle\Entity\ImageProfileAvatar $thumbnail)
    {
        $this->setUniqueImageCopy($thumbnail);
    }
    ...
    public function setImageProfileSquare(\MireiaBackend\ImageBundle\Entity\ImageProfileSquare $thumbnail)
    {
        $this->setUniqueImageCopy($thumbnail);
    }
    ...
    {
        $class = "MireiaBackend\\ImageBundle\\Entity\\$type";
