...
namespace MireiaBackend\ImageBundle\Form\Handler;

use MireiaBackend\BackendBundle\Entity\AdminUser;
use MireiaBackend\ImageBundle\Entity\ImageProfile;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Form\FormInterface;
use MireiaBackend\ImageBundle\Form\Handler\ImageManager;
use MireiaBackend\ImageBundle\Entity\Image;
use MireiaBackend\BlogBundle\Entity\Post;
use MireiaBackend\ImageBundle\Entity\ImagePost;
use MireiaBackend\ImageBundle\Entity\ImageAvatar;
...
class CreateImageHandler
{
    ...
    {
        return "MireiaBackend\\ImageBundle\\Entity\\" . $objName;
    }
}