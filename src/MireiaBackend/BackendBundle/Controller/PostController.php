...
use MireiaBackend\BlogBundle\Entity\FeedbackPositive;
use MireiaBackend\BlogBundle\Entity\FeedbackNegative;
...
class PostController extends CustomController
{
    ...
    public function sendFeedbackAction(Post $post, Request $request)
    {
        ...
        $className = 'MireiaBackend\\BlogBundle\\Entity\\Feedback' . ucfirst($data['type']);
