<?php
namespace MireiaBackend\BackendBundle\Entity;
...
/**
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="MireiaBackend\BackendBundle\Entity\AdminUserRepository")
...
class AdminUser implements AdvancedUserInterface, \Serializable, EquatableInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MireiaBackend\ImageBundle\Entity\ImageAvatar")
     */
    protected $avatar;

    /**
     * @ORM\OneToMany(targetEntity="MireiaBackend\ImageBundle\Entity\ImageProfile", mappedBy="user", cascade={"persist", "remove", "merge"})
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="MireiaBackend\BackendBundle\Entity\Role", inversedBy="users")
